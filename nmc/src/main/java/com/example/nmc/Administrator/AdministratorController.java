...
@Controller
@RequestMapping("/pegawai/administrator")
public class AdministratorController {
    ...
    public String menuUtama(Model model){
        List<PendaftaranPasienDTO> pendaftaranList = this.repo.showAll();
    ...
    try {
        ...
        pendaftaran.setStatuspendaftaran("Belum Diperiksa");
    ...
    @PostMapping("bayar")
    public String addTransaksi(@Valid Transaksi transaksi) {
