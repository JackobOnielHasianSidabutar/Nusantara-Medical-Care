...
public class JdbcAdministratorRepository implements AdministratorRepository {
    ...
    @Override
    public List<PendaftaranPasien> showAll() {
    ...
    private PendaftaranPasien mapRowToPendaftaran(ResultSet resultSet, int rowNum) throws SQLException {
        return new PendaftaranPasien(
